...
SPEC = [
    ...
    ("switch_tab", ["switch to the {} tab"], ["go to the {} tab"], (["github", "mail", "docs"], ["reddit"]), None),
    ...
    ("upscale_image", ["upscale {}", "increase the resolution of {}"], ["make {} bigger"], IMAGES, None),
    ...
    ("ask_document", ['what does the document ~/report.pdf say about the budget'], ['what does the document ~/report.pdf say about the budget'], NONE, 'what does it say about the budget\t~/report.pdf'),
    ("ask_document", ['what does the document ~/notes.txt say about the meeting'], ['what does the document ~/notes.txt say about the meeting'], NONE, 'what does it say about the meeting\t~/notes.txt'),
