...
Joshua, 2026-09-25: loop until 5.0, watching usage. 5.0 means both blind held-out sets (eval/heldout.jsonl, eval/heldout2.jsonl) show under ten wrong picks past the guard and zero right picks refused, with the standard set no worse. Taper (CI and red fixes only, hourly) while weekly usage is critical; full rounds after the Saturday 22:00 reset.
