...
MUST_HIDE = {"ask_llm", "run_shortcut", "copy_to_clipboard", "sleep_display", "call_mcp_tool", "close_tab", "remember", "recall", "forget", "read_screen", "ask_screen"}
...
SPOKEN = {"ask_llm": "ask qwen why is the sky blue", "click_text": "click Sign in", "type_text": "type hello", "press_key": "press return", "new_note": "take a note buy milk", "new_reminder": "remind me to call mom", "make_logo": "make me a logo for turing",
