...
FIXED = [
    ...
    "what time is 3pm pst in tokyo", "convert 3pm pst to tokyo", "15:30 london to new york", "noon utc in vancouver", "midnight est to london", "3:30 p.m. PST in Tokyo", "10pm eastern time in pacific", "9am Asia/Tokyo to Europe/London", "11:59 pm hst to auckland", "12am jst in honolulu", "whats 9am utc in narnia", "13pm pst in tokyo", "days until 2000-01-01", "100 days from now", "3 weeks ago", "2 months after 2026-01-31", "1 month after january 31 2024", "13 months after 2026-01-31", "a week before christmas", "what day of the week was july 4 1976", "what day was 4 july 1976", "day of the week for 29th february 2024", "what day is 2026-02-30", "what day of the week is 2023-02-29", "days between 2026-01-01 and 2026-12-25", "days between 9999-12-31 and 0001-01-01", "days between yesterday and tomorrow", "how many days between july 4 1776 and 2026-07-04", "1 day before 0001-01-01", "999999 years from now", "5 days from tomorrow", "0 days from today", "ten years after 2016-02-29", "days until 2999-12-31", "days until soon", "days until 2026-02-31",
...
MAC_ONLY = ["disk space", "uptime", "how much memory do i have", "cpu load", "what is my ip", "what wifi am i on", "system info",
            "copy hello to my clipboard", "lock the screen", "reveal ~/Documents in finder", "list my shortcuts", "run shortcut morning routine", "list my mcp tools", "call mcp samantha calculate {}", "read my screen", "what does document ~/a.pdf say about milk", "in document ~/a.pdf what is the total", "on my screen, what is the total", "read document ~/notes.pdf", "find milk in document ~/notes.pdf", "find milk on my screen", "list my tabs", "switch to the github tab", "close the github tab", "read tab 2", "read this tab"]
