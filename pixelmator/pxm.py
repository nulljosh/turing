...
# what a spec may say (exit codes, shape tables, PxmError, validate_spec) lives in pxm_spec.py; re-exported here
from pxm_spec import *  # noqa: E402,F401,F403
from pxm_spec import _is_num  # noqa: E402,F401
